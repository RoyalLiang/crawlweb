...
export default new Router({
    ...
    routes: [
        ...
        },
        {
            path: '/project/home',
            name: 'project-home',
            component: () => import('../pages/projectPage/home'),
        },
        {
            path: '/project/timeTask',
            name: 'project-home',
            component: () => import('../pages/projectPage/timeTask'),
        },
        {
            path: '/project/addTask',
            name: 'project-home',
            component: () => import('../pages/projectPage/addTask'),
        },
        {
            path: '/project/projects',
            name: 'project-projects',
            component: () => import('../pages/projectPage/projects'),
        },
        // {
        //     path: '/storage/oss',
        //     name: 'storage-oss',
        //     component: () => import('../pages/StoragePage/OSS/'),
        // },
        ...
        //     component: () => import('../pages/userPage/Login.vue'),
        // },
        // {
